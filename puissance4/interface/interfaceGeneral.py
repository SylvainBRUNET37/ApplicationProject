...
def creerFrameHaut(toplevelFenetre: tk.Tk) -> None:
    """
        @brief  Créé le haut des pages : le bouton pour revenir en arrière, le nom du jeu et le bouton quitter
...
def creerBoutonRetour(fonctionRetour, dictParametre: dict, toplevelFenetre: tk.Tk) -> None:
    """
        @brief Gère la création du bouton de retour : lorsque le bouton est cliqué, détruit la fenêtre actuelle et reviens à la fenêtre d'avant
