...
def main(master=None):
    ...
    button_quitter.configure(cursor="hand2", font="{Arial} 16 {}", overrelief="sunken", text='Quitter')
    button_quitter.place(anchor="nw", relx=0.78, rely=0.04, x=0, y=0)
    label_nomJeu = tk.Label(frame_haut)
    label_nomJeu.configure(font="{Arial} 20 {bold underline}",text='Puissance N')
    ...
    label_logo.configure(cursor="coffee_mug", height=50, image=img_logo,width=50)
    ...
    button_JvsIA.configure(cursor="hand2", font="{Arial} 16 {}", overrelief="sunken", text='Joueur \nVS \nIA', width=8)
    button_JvsIA.place(anchor="nw", relx=0.6, rely=0.0, x=0, y=0)
    button_JvsJ = tk.Button(frame_choixAdversaire)
    button_JvsJ.configure(cursor="hand2", font="{Arial} 16 {}", overrelief="sunken", text='Joueur \nVS \nJoueur', width=8)
